...
\begin{Rmk}{}
    For a real function $f$, we say that $\lim\limits_{x\to x_0} f(x)$ exists if there is some real number $l$ such that $\lim\limits_{x\to x_0} f(x) = l$.\\
    ...
    \begin{compactenum}
        ...
        \item (arithmics of limits) If both $\lim\limits_{x\rightarrow x_0} f(x)$ and $\lim\limits_{x\rightarrow x_0} g(x)$ exist, then:
        \begin{compactitem}
...
\begin{Df}{$\circ$ Df2.3 (types of discontinuous point)}
    Suppose $f$ is a real function and there is some $B_\delta(x_0)$ s.t. $\text{dom}(f)\supseteq B_\delta(x_0)$ (namely, $f$ is continuous at $x_0$ $\Leftrightarrow$ $\lim\limits_{x\to x_0} f(x) = f(x_0)$ $\Leftrightarrow$ $\lim\limits_{x\to x_0^-} f(x) = \lim\limits_{x\to x_0^+} f(x) = f(x_0)$ $\Leftrightarrow$ $f$ is both left continuous and right continuous at $x_0$). Suppose also $x_0$ is a discontinuous point of $f$ (and thus $\lim\limits_{x\to x_0^-} f(x) = \lim\limits_{x\to x_0^+} f(x) = f(x_0)$ does not holds). Then the discontinuous point $x_0$ can be further classified into the following types:
    \begin{compactenum}
